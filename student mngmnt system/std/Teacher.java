...
public class Teacher {
    ...
    private void fremForTeacher() throws IOException {
		...
		save.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    System.out.println(courseTable.isCellEditable(0,2));
					iterateTables(courseTable,course);
	...
	private void iterateTables( JTable courseTable,String course ) throws IOException{
        ...
        ;
        courseTable.addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {
                String value1= String.valueOf(e.getKeyChar());
                courseTable.setValueAt(value1,0,2);
                String value2= String.valueOf(e.getKeyChar());
                courseTable.setValueAt(value1+value2,0,2);
    ...
    public static void main(String[] args) throws IOException {
        Teacher teacher = new Teacher("e","Object Oriented Programming");
    }
}
