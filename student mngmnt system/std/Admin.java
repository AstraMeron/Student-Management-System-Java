...
public class Admin {
    ...
    void homePage() {
        ...
        JLabel nameLabel = new JLabel("Teachers Staff");
	...
	void addTeachers() {
		...
		String[] courseOptions = {"math", "signal", "Object Oriented Programming", "History", "database"};
	...
	private void staticData() throws IOException {
		...
		String[] courseOptions = {"Grade","math", "signal", "Object Oriented Programming", "History", "database"};
	...
	private void readStudent() throws IOException{
		...
		while ((data = readFile.readLine()) != null) {
			...
			if (dataRead.length >= 3) {
				String role = dataRead[2];
				String name = dataRead[0];
