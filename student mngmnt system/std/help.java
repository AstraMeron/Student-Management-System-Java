...
public class help {
    ...
    help() {
		...
		addQA(helpLabels, "Q0: How to enter the system?", "To enter our system we have already temporary password and username admin <html><h3> username 'admin' and password also 'admin'</h3> <h3>");
